...
const stats = [
  { label: "Design Tokens", count: "60+", description: "Colors, typography, spacing, radius, shadows" },
  { label: "Atoms", count: "16", description: "Button, Input, Badge, Typography, Avatar, etc." },
  { label: "Molecules", count: "8", description: "FormField, SearchBar, StatCard, NavItem, etc." },
  { label: "Organisms", count: "10", description: "TopBar, Sidebar, DataTable, AuthForm, etc." },
  { label: "Templates", count: "8", description: "AppShell, Editor, Library, Dashboard, Auth, etc." },
];
...
const sections = [
  ...
  { name: "Atoms", path: "/atoms", icon: Box, desc: "Buttons, inputs, badges, typography, avatars, form elements" },
  { name: "Molecules", path: "/molecules", icon: Layers, desc: "Form fields, search bar, stat cards, breadcrumbs" },
  { name: "Organisms", path: "/organisms", icon: LayoutGrid, desc: "Top bar, sidebar, data table, auth form, prompt cards" },
  { name: "Templates", path: "/templates", icon: Layout, desc: "App shell, editor, library, dashboard, auth layouts" },
  { name: "Pages", path: "/pages", icon: FileText, desc: "Dashboard, library, editor, settings, auth page index" },
];
